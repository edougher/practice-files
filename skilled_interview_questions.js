...
2- find out (return true/false) if a given word is a palindrome. kayak mom racecar
	BONUS: do the same with sentences. ie "A Man, A Plan, A Canal, Panama!"
3- given an array of integers find the most repeated number
	findMostRepeated([4,4,3,4,4,1,1,1,1,1,4,4,4,4,6,6,6,1,1,4,4]) = 4
4- given an array of integers find the number with the longest repeating sequence
	findLongestSequence([4,4,3,4,4,1,1,1,1,1,4,4,4,4,6,6,6,1,1,4,4]) = 1
